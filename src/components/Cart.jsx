      ...
      <div class="mb-6 flex flex-col gap-4 sm:mb-8 md:gap-6">
        ...
        <div class="flex flex-wrap gap-x-4 overflow-hidden rounded-lg border sm:gap-y-4 lg:gap-6 bg-gray-200">
          <a href="#" class="group relative block h-48 w-32 overflow-hidden bg-gray-100 sm:h-56 sm:w-40">
            <img src="./img/23568329_s.jpg" loading="lazy" alt="Photo by Thái An" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
          </a>
        ...
        <div class="flex flex-wrap gap-x-4 overflow-hidden rounded-lg border sm:gap-y-4 lg:gap-6 bg-gray-200">
          <a href="#" class="group relative block h-48 w-32 overflow-hidden bg-gray-100 sm:h-56 sm:w-40">
            <img src="./img/23568329_s.jpg" loading="lazy" alt="Photo by Jessica Radanavong" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
          </a>
        ...
        <div class="flex flex-wrap gap-x-4 overflow-hidden rounded-lg border sm:gap-y-4 lg:gap-6 bg-gray-200">
          <a href="#" class="group relative block h-48 w-32 overflow-hidden bg-gray-100 sm:h-56 sm:w-40">
            <img src="./img/26579281_s.jpg" loading="lazy" alt="Photo by vahid kanani" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
          </a>
