  ...
  return (
    <div className="p-4 mr-20 ml-20 mb-20">
      ...
      <ol className="list-decimal ml-8 mb-4">
        ...
        <li className="mb-2">
          マーケティング目的での連          コンタクトを希望しない場合、または個人情報の収集に同意しない場合、お客様はいつでも選択する権利を有しています。
        </li>
      </ol>
      <h3 className="text-lg font-bold mb-2">【子供のプライバシー保護】</h3>
      <p className="mb-4">
        当ウェブサイトは、13歳未満の子供から意図的に個人情報を収集することはありません。もし13歳未満の子供の個人情報を誤って収集した場合、速やかに削除するための手続きを講じます。
      </p>
