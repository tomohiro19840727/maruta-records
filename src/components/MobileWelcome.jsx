  ...
  <section class="mx-auto max-w-screen-2xl px-5 ">
    ...
    <div class="flex flex-col items-center justify-between gap-8 md:flex-row">
      ...
      <div class="flex items-center justify-center gap-4 lg:justify-start mt-10">
        {/* <Link to="/memberlogin" class="text-lg font-semibold uppercase tracking-widest text-gray-400">ログイン</Link> */}
        {/* <Link to="/signup" class="text-lg font-semibold uppercase tracking-widest text-gray-400">会員登録</Link> */}

        <Link to="/memberlogin" class="px-5 py-4 relative rounded group font-medium text-white font-medium inline-block mr-10 text-xl">
...
<span class="relative">ログイン</span>
        ...
        <Link to="/signup" class="px-5 py-4 relative rounded group font-medium text-white font-medium inline-block text-xl">
<span class="absolute top-0 left-0 w-full h-full rounded opacity-50 filter blur-sm bg-gradient-to-br from-purple-600 to-blue-500"></span>
<span class="h-full w-full inset-0 absolute mt-0.5 ml-0.5 bg-gradient-to-br filter group-active:opacity-0 rounded opacity-50 from-purple-600 to-blue-500"></span>
<span class="absolute inset-0 w-full h-full transition-all duration-200 ease-out rounded shadow-xl bg-gradient-to-br filter group-active:opacity-0 group-hover:blur-sm from-purple-600 to-blue-500"></span>
<span class="absolute inset-0 w-full h-full transition duration-200 ease-out rounded bg-gradient-to-br to-purple-600 from-blue-500"></span>
<span class="relative">
  <p className='text-lg text-center'>(無料)</p>会員登録</span>
</Link>
{/* 
