  ...
  <section class="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div class="mb-8 flex flex-wrap justify-between md:mb-16">
      <div class="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pt-48 lg:pb-24">
        <h1 class="text-black-800 mb-4 text-4xl font-bold sm:text-5xl md:mb-8 md:text-6xl">Find your<br />style Music</h1>

        <p class="max-w-md leading-relaxed text-gray-500 xl:text-lg">豊かな音楽の世界を極上のレコードで体験せよ。<br/>オールジャンル、希少盤も充実。あなたの音楽旅を彩る最高の選択肢。</p>
      </div>
