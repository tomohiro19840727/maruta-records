    ...
    <div class="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 lg:gap-8">
      ...
      <div class="flex flex-col items-center rounded-lg bg-gray-100 p-4 lg:p-8">
        <div class="mb-2 h-24 w-24 overflow-hidden rounded-full bg-gray-200 shadow-lg md:mb-4 md:h-32 md:w-32">
          <img src="./img/IMG_6801.JPG" loading="lazy" alt="Photo by Radu Florin" class="h-full w-full object-cover object-center" />
        </div>

        <div>
          <div class="text-center font-bold text-indigo-500 md:text-lg">Taketo
        Yamazaki</div>
          ...
          <div class="flex justify-center">
            <div class="flex gap-4">
              <Link to="https://instagram.com/taketoyamazaki" target="_blank" class="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600">
      ...
      <div class="flex flex-col items-center rounded-lg bg-gray-100 p-4 lg:p-8">
        ...
        <div>
          <div class="text-center font-bold text-indigo-500 md:text-lg">Hirano</div>
