      ...
      <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div class="mb-10 md:mb-20">
          <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-5xl">
            "Groove Odyssey: Journey Through Vinyl Sounds"
          </h2>
          <p class="mx-auto max-w-screen-md text-center text-gray-500 md:text-2xl">
            「グルーヴ・オデッセイ：ヴァイナル・サウンドの旅」
          </p>
        </div>
        <div class="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-8">
          {newsSortedLists.map((post) => {
            const truncatedText = post.postsText2.split('\n').slice(0, 3).join('\n');
            return (
              <div class="flex flex-col overflow-hidden rounded-lg border bg-white" key={post.id}>
                <Link
                  to="/eventdetail"
                ...
                <div class="flex flex-1 flex-col p-4 sm:p-6">
                  ...
                  <div class="mt-auto flex items-end justify-between">
                    <div class="flex items-center gap-2">
                      <div class="h-10 w-10 shrink-0 overflow-hidden rounded-full bg-gray-100"></div>
                      <div>
                        <span class="block text-indigo-500">Mike Lane</span>
                    ...
                    {!isAuth ? (
                      ...
                      <button
                        ...
                        class="rounded border px-2 py-1 text-sm text-gray-500"
                      >
                        削除
                      </button>
                    )}
