    ...
    <div class="grid gap-x-4 gap-y-6 sm:grid-cols-2 md:gap-x-6 lg:grid-cols-3 xl:grid-cols-4">
      ...
      <div>
        <a href="#" class="group mb-2 block h-96 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
          <img src="./img/スクリーンショット 2023-06-15 14.27.00.png" loading="lazy" alt="Photo by Austin Wade" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
        </a>

        <div class="flex flex-col">
          <span class="text-gray-500">山崎</span>
          <a href="#" class="text-lg font-bold text-gray-800 transition duration-100 hover:text-gray-500 lg:text-xl">今、売れています</a>
        </div>
      </div>
      ...
      <div>
        <a href="#" class="group mb-2 block h-96 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
          <img src="./img/スクリーンショット 2023-06-15 14.27.00.png" loading="lazy" alt="Photo by engin akyurt" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
        </a>
    ...
    <div class="grid gap-8 md:grid-cols-2">
      ...
      <div class="space-y-4">
        <div class="relative overflow-hidden rounded-lg bg-gray-100">
          <img src="./img/スクリーンショット 2023-06-15 14.51.13.png" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="overflow-hidden rounded-lg bg-gray-100">
            <img src="./img/スクリーンショット 2023-06-15 14.52.14.png" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
          </div>
    ...
    <div class="mb-6 flex flex-col gap-4 sm:mb-8 md:gap-6">
      ...
      <div class="flex flex-wrap gap-x-4 overflow-hidden rounded-lg border sm:gap-y-4 lg:gap-6">
        <a href="#" class="group relative block h-48 w-32 overflow-hidden bg-gray-100 sm:h-56 sm:w-40">
          <img src="./img/スクリーンショット 2023-06-15 14.27.00.png" loading="lazy" alt="Photo by Thái An" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
        </a>
      ...
      <div class="flex flex-wrap gap-x-4 overflow-hidden rounded-lg border sm:gap-y-4 lg:gap-6">
        <a href="#" class="group relative block h-48 w-32 overflow-hidden bg-gray-100 sm:h-56 sm:w-40">
          <img src="./img/スクリーンショット 2023-06-15 14.27.00.png" loading="lazy" alt="Photo by Jessica Radanavong" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
        </a>
      ...
      <div class="flex flex-wrap gap-x-4 overflow-hidden rounded-lg border sm:gap-y-4 lg:gap-6">
        <a href="#" class="group relative block h-48 w-32 overflow-hidden bg-gray-100 sm:h-56 sm:w-40">
          <img src="./img/スクリーンショット 2023-06-15 14.27.00.png" loading="lazy" alt="Photo by vahid kanani" class="h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
        </a>
